...
class _AddEditGoalScreenState extends ConsumerState<AddEditGoalScreen> {
    ...
    if (widget.goalId != null) {
      WidgetsBinding.instance.addPostFrameCallback((_) {
        ...
        setState(() {
          ...
          _targetAmountController.text = _formatAmountWithDots(
  ...
  String _formatAmountWithDots(String text) {
              ...
              onPressed: () {
                showDialog(
                  ...
                  builder: (ctx) => AlertDialog(
                    ...
                    content: const Text(
                      'Yakin mau hapus goal ini? Aksi ini tidak bisa dibatalkan.',
                    ),
                    actions: [
                      TextButton(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    TextFormField(
                      ...
                      decoration: _inputDecoration('Contoh: MacBook Pro'),
...
class _RupiahInputFormatter extends TextInputFormatter {
  ...
  TextEditingValue formatEditUpdate(
    ...
    final formatted = _formatWithDots(text);
  ...
  String _formatWithDots(String text) {
    final buffer = StringBuffer();
    final length = text.length;
    for (int i = 0; i < length; i++) {
      if (i > 0 && (length - i) % 3 == 0) {
