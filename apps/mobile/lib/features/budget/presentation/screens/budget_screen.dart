          ...
          Padding(
            ...
            child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                final budgetProgress = budget.totalAmount > 0
                ...
                return Slidable(
                  ...
                  child: _buildCategoryCard(
                    ...
                    leftAmt:
                        'Rp ${(budget.totalAmount - budget.spentAmount).toInt()}',
              ...
              itemBuilder: (context, index) {
                ...
                return GestureDetector(
                  ...
                  child: _buildGoalCard(
                    ...
                    tagTextColor: isComplete
                        ? Colors.green.shade600
                        : goal.tagTextColor,
                    icon: goal.icon,
                    progress: progress,
                    target: 'Rp ${goal.targetAmount.toInt()}',
                    shortfall: isComplete
                        ? 'Done'
                        : 'Rp ${(goal.targetAmount - goal.savedAmount).toInt()}',
          ...
          Padding(
            ...
            child: Column(
              children: [
                ...
                Text(
                  shortfall == 'Done' ? 'Complete' : 'Kurang $shortfall',
                  style: TextStyle(
                    fontSize: 9,
                    fontWeight: FontWeight.bold,
                    color: shortfall == 'Done' ? Colors.green : Colors.red,
                  ),
                ),
                const Spacer(),
                Container(
...
class _BillsContent extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final progress = totalBillsAmount > 0
        ? (paidAmount / totalBillsAmount).clamp(0.0, 1.0)
        : 0.0;
                    ...
                    children: [
                      Row(
                        ...
                        children: [
                          ...
                          Text(
                            totalBillsAmount.toInt().toString(),
                            style: textTheme.headlineMedium?.copyWith(
                              fontWeight: FontWeight.w900,
                              color: Colors.black,
                              letterSpacing: -0.5,
          ...
          Padding(
            ...
            child: Column(
              children: upcomingBills.map((bill) {
                final daysLeft = bill.dueDate != null
                    ? bill.dueDate!.difference(DateTime.now()).inDays
                    : 0;
                String dateTag = bill.dueDate != null
                    ? (daysLeft >= 0
                          ? 'Due in $daysLeft days'
                          : 'Overdue by ${daysLeft.abs()} days')
                    : 'No due date';
                Color dateTagColor = daysLeft <= 2
                    ? Colors.red.shade50
                    : Colors.orange.shade50;
                Color dateTagTextColor = daysLeft <= 2
                    ? Colors.red.shade600
                  ...
                  children: paidBills.map((bill) {
                    return Dismissible(
                      ...
                      child: _buildPaidCard(
                        title: bill.name,
                        dateStr: bill.dueDate != null
                            ? 'Paid on ${bill.dueDate!.day}/${bill.dueDate!.month}'
                            : 'Paid',
                        amount: 'Rp ${bill.amount.toInt()}',
                        icon: bill.icon,
                      ),
